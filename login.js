document.addEventListener("DOMContentLoaded", () => {
    ...
    if (loginBtn) {
        loginBtn.addEventListener("click", async () => {
            ...
            try {
                const response = await fetch("https://api.jsonbin.io/v3/qs/6850f0938a456b7966af7036");///1
    ...
    if (signupBtn) {
        signupBtn.addEventListener("click", async () => {
            ...
            try {
                const usersResponse = await fetch("https://api.jsonbin.io/v3/qs/6850f0938a456b7966af7036");//2
                ...
                const signupResponse = await fetch("https://api.jsonbin.io/v3/qs/6850f0938a456b7966af7036", {//3
                    method: "POST",
                    headers: {
